...
export function CodePreviewSectionV2() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <Badge
              variant="secondary"
              className="mb-6 bg-primary/10 text-primary border-none text-xs"
            >
              Developer First
            </Badge>
          ...
          <Card className="relative border-border/50 rounded-xl bg-card overflow-hidden">
